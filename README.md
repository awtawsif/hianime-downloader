...
```bash
git clone https://github.com/awtawsif/hianime-downloader.git
...
1. Get the master playlist URL from hianime.to:
   ...
   **Option 1: Using Browser Extension (Recommended)**
   - Install the Media Stream Detector browser extension from [GitHub](https://github.com/awtawsif/media-stream-detector)
